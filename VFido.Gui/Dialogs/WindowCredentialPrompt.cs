...
{
    public Task<(string Username, string Password)?> RequestCredentialsAsync(string stickName, bool requireUsername, string? prefilledUsername)
    {
        ...
        return owner == null
            ...
            : PasswordPromptWindow.ShowAsync(owner, stickName, requireUsername, prefilledUsername);
    }
}

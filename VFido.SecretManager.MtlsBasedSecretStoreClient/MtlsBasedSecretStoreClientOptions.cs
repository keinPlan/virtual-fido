...
namespace VFido.SecretManager.MtlsBasedSecretStoreClient
{
    ...
    /// leaf certificate (issued by the server's CA, proves this device's identity), the CA
    /// certificate to validate the server's presented certificate against, and the
    /// username/password login presented once the channel is established.
    /// </summary>

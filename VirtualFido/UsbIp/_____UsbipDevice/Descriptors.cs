namespace UsbipDevice
{
    ...
    public class FidoDescriptors()
    {

       public static byte[] USBD_DESCRIPTOR = new byte[]{
            0x09, /* bLength: Configuration Descriptor size */
  0x02, // bDescriptorType: Configuration  USB_DESC_TYPE_CONFIGURATION
  9 + 9 + 9+ 7+7,
  ...
  0x04, // bDescriptorType: Interface descriptor type USB_DESC_TYPE_INTERFACE                           
  ...
  34 ,// HID_FIDO_REPORT_DESC_SIZE,/*wItemLength: Total length of Report descriptor*/
  0x00,
  /******************** Descriptor of Mouse endpoint ********************/
  0x07,          /*bLength: Endpoint Descriptor size*/
  5 ,// USB_DESC_TYPE_ENDPOINT USB_DESC_TYPE_ENDPOINT, /*bDescriptorType:*/
  0x81 , // HID_EPIN_ADDR,     /*bEndpointAddress: Endpoint Address (IN)*/
  0x03,          /*bmAttributes: Interrupt endpoint*/
  64 , //HID_EPIN_SIZE, /*wMaxPacketSize: 4 Byte max */
  0x00,
  5, //HID_BINTERVAL,          /*bInterval: Polling Interval */


  0x07,          /*bLength: Endpoint Descriptor size*/
  5 ,// USB_DESC_TYPE_ENDPOINT USB_DESC_TYPE_ENDPOINT, /*bDescriptorType:*/
  0x01 ,//HID_EPOUT_ADDR,     /*bEndpointAddress: Endpoint Address (IN)*/
  0x03,          /*bmAttributes: Interrupt endpoint*/
  64 ,//HID_EPOUT_SIZE, /*wMaxPacketSize: 4 Byte max */
  0x00,
   5//HID_BINTERVAL,          /*bInterval: Polling Interval */
};
        ...
        byte[] USBD_HID_DeviceQualifierDesc = new byte[]{
              0x0a,//USB_LEN_DEV_QUALIFIER_DESC,
              6 ,// USB_DESC_TYPE_DEVICE_QUALIFIER,
              0x00,
              0x02,
              0x00,
              0x00,
        ...
        byte[] HID_MOUSE_ReportDesc = new byte[] {
